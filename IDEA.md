...
> **Update:** Slack (Incoming Webhook) ist inzwischen umgesetzt (Branch
> `slack`, `src/channels/slack.rs` + `slack_webhook_url` in `config.toml`).
> Der Rest dieses Dokuments ist weiterhin offen.
